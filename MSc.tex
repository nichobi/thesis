...
\begin{figure}[]
  ...
  \begin{tikzpicture}[
    ...
    \node (typerules)                               {Typing rules\\definition};
    ...
    \node (olast)     [below=of typerules] {AST definition};
    ...
    %  \end{itemize}
    %};
    \node (templateparser)        [below=of outputparsing]                               {Tree-based\\parser};
    \node (templateprojectfiles)  at (inputast |- templateparser)                        {Project files};
    \node (typecheckingalgorithm) at (outputtypechecking |- templateparser)              {Type check\\algorithm};
