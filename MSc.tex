...
%Leave a \textit{2cm} vertical space after the abstract and provide a few keywords relevant for your report. Use five to six words, of which at most two should be from the title.
  ...
  This report contains a study on the usability of JastAdd to programmatically generate executable type checkers from a subset of possible typing rules.
  ...
  We find RAGs to be a flexible model for this subset of typing rules,
  % This is too specific, works with small languages from research literature
  and our software was able to support simple values, nodes with premises placing demands on their children, and those with rules requiring type variables.
...
%TODO: Rewrite this section to be less bad
...
We have chosen to evaluate our program using two example languages, inspired by the languages Booleans and Numbers introduced in Types and Programming Languages\ref{Pierce}.
...
%\end{minipage}
%\end{figure}
As an example of rules utilising type variables, we have extended the Bools language with an if term, as used in Pierce's Booleans language\ref{Pierce}.
